...
public:
	...
	IGL_INLINE bool MultipleViews();
	void IK();
	void LiftSnake(double delta);
	void TranslateSnake(Eigen::Vector3f& delta);
	void InvertSnake();
	...
	void TranslateLinks(int root_index);
	void TranslateArm();
