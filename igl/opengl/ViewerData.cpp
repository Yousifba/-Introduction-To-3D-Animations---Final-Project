...
IGL_INLINE void igl::opengl::ViewerData::uniform_colors_index(int i)
{
	...
	{
		uniform_colors(
			Eigen::Vector3d(grass_mat_ambient[0], grass_mat_ambient[1], grass_mat_ambient[2]),
			Eigen::Vector3d(grass_mat_diffuse[0], grass_mat_diffuse[1], grass_mat_diffuse[2]),
			Eigen::Vector3d(grass_mat_specular[0], grass_mat_specular[1], grass_mat_specular[2]));
	}
	else if (i == 5) // Concrete
	{
		uniform_colors(
			Eigen::Vector3d(grey_mat_ambient[0], grey_mat_ambient[1], grey_mat_ambient[2]),
			Eigen::Vector3d(grey_mat_diffuse[0], grey_mat_diffuse[1], grey_mat_diffuse[2]),
			Eigen::Vector3d(grey_mat_specular[0], grey_mat_specular[1], grey_mat_specular[2]));
	}
}
